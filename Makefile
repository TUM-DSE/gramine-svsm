...
container:
	docker run --privileged -v ${PWD}:/gramine -w /gramine gramine-build-container

build_external:
	docker run --privileged -v ${PWD}:/gramine -w /gramine gramine-build-container make "BUILD_MODE=${BUILD_MODE}"
