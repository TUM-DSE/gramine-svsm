...
// XXX: The original: https://github.com/gramineproject/gramine-tdx/blob/b6e97234ec8afce4a5fb6ce94aeea6869a3bb82e/pal/src/host/vm-common/pal_common_tf.h
...
/*
 * Perhaps confusingly, `struct trusted_file` describes not only "svsm.trusted_files" but also
...
struct trusted_file {
    ...
    uint64_t size;
    bool allowed;
    svsm_file_hash_t file_hash;      /* hash over the whole file, retrieved from the manifest */
    svsm_chunk_hash_t* chunk_hashes; /* array of hashes over separate file chunks */
    size_t uri_len;
